...
import com.rohit.cms.articles.PremiumArticleBuilder;
import com.rohit.cms.main.ValidatorFactory;
import com.rohit.cms.models.Article;
import com.rohit.cms.models.Validator;

class PremiumArticleBuilderTest {
	static PremiumArticleBuilder builder;
	...
	void testAddTitle() throws Exception {
		...
		assertEquals(article.title, "[Premium]test");
	}
	...
	void testAddText() throws Exception {
		...
		assertEquals(article.text, "(You are reading Premium article!) \n"+"text12345");
	}
	...
	void testAddTags() throws Exception {
		...
		assertEquals(article.tags.length, 3);//new String[] {"tag1", "tag1"});
	}
